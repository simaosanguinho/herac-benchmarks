...
This demo measures the TCP communication and serialization overhead of two VMs running on a single host. The demo can run both in JVM and SVM (with PGO) mode.
