...
plt.annotate('Hydra Sandbox', xy=(x[0] + .125, y[0] - 0.1))
plt.annotate('Hydra Fork', xy=(x[1] + 1, y[1]))
plt.annotate('Firecracker C/R', xy=(x[2] + 4.5, y[2]))
plt.annotate('Hydra Runtime', xy=(x[3] + 4.5, y[3]))
