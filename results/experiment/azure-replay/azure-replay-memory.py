...
maybe_plot_with_fallback("hy_footprint.txt", "gv_dc_footprint.txt", "Hydra", scale=1000, linestyle=":", linewidth=3)
...
maybe_plot_with_fallback("ow_footprint.txt", "cr_footprint.txt", "OpenWhisk", scale=1000, linestyle="-", marker="x", markersize=10, markevery=10, linewidth=3)
maybe_plot_with_fallback("kn_footprint.txt", "knative_footprint.txt", "Knative", scale=1000, linestyle="--", linewidth=3)
plt.xlabel("Time (s)")
