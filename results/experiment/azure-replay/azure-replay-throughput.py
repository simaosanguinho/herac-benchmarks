...
maybe_plot_with_fallback("hy_throughput.txt", "gv_dc_throughput.txt", "Hydra", linestyle=":", linewidth=3)
...
maybe_plot_with_fallback("ow_throughput.txt", "cr_throughput.txt", "OpenWhisk", linestyle="-", marker="x", markersize=10, markevery=10, linewidth=3)
maybe_plot_with_fallback("kn_throughput.txt", "knative_throughput.txt", "Knative", linestyle="-", marker="o", markersize=10, markevery=10, linewidth=3)
plt.xlabel("Time (s)")
