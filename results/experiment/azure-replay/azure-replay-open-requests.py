...
maybe_plot_with_fallback("ow_open_requests.txt", "cr_open_requests.txt", "OpenWhisk", linestyle="-", marker="x", markersize=10, markevery=10, linewidth=3, color="tab:green")
maybe_plot_with_fallback("kn_open_requests.txt", "knative_open_requests.txt", "Knative", linestyle="--", marker="o", markersize=10, markevery=10, linewidth=3, color="tab:red")
maybe_plot("he_open_requests.txt", "Herac", linestyle="-.", linewidth=3, color="tab:blue")
maybe_plot_with_fallback("hy_open_requests.txt", "gv_dc_open_requests.txt", "Hydra", linestyle=":", linewidth=3, color="tab:orange")
