...
maybe_plot_with_fallback("hy_active_lambdas.txt", "gv_dc_active_lambdas.txt", "Hydra", linestyle=":", linewidth=3)
...
maybe_plot_with_fallback("ow_active_lambdas.txt", "cr_active_lambdas.txt", "OpenWhisk", linestyle="-", marker="x", markersize=10, markevery=10, linewidth=3)
plt.xlabel("Time (s)")
