...
maybe_plot_with_fallback("ow_active_lambdas.txt", "cr_active_lambdas.txt", "OpenWhisk", linestyle="-", marker="x", markersize=10, markevery=10, linewidth=3, color="tab:green")
maybe_plot_with_fallback("kn_active_lambdas.txt", "knative_active_lambdas.txt", "Knative", linestyle="-", marker="o", markersize=10, markevery=10, linewidth=3, color="tab:red")

maybe_plot("he_active_lambdas.txt", "Herac", linestyle="-.", linewidth=3, color="tab:blue")
maybe_plot_with_fallback("hy_active_lambdas.txt", "gv_dc_active_lambdas.txt", "Hydra", linestyle=":", linewidth=3, color="tab:orange")
