...
function build_ni {
	...
	$JAVA_HOME/bin/native-image \
		...
		-cp libs/compression-1.0-all.jar:$ARGO_HOME/graalvisor-lib/build/libs/graalvisor-lib-1.0-guest.jar \
...
function build_ni_standalone {
	NI_BIN_OPTS="com.compression.Compression"
	build_ni
}
