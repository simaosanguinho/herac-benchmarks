 ...
 * @param {string} key - password for encryption.
 ...
 * @param {string} key - password for decryption.
 ...
 * @return {Map<any, any>} - encrypted/decrypted message.
 */
const main = function (args) {
    ...
    if (args.get("type") === "encrypt") {
        output.set("result", encrypt(message, password))
    } else {
        if (args.get("type") === "decrypt") {
            output.set("result", decrypt(message, password))
        } else {
            output.set("result", "Wrong selection! Possible: encrypt or decrypt!")
        }
    }
    return output
}
