...
THROUGHPUT_METRIC = "startup-throughput"
width = 0.3
benchmark_labels = [
    "Tika",
    "Petclinic",
...
ax.set_ylabel('Startup throughput (ops/s)')
...
# ax.set_yscale('log')
ax.set_ylim(ymin=0.1, ymax=15000)
# ax.set_xlim(xmin=-.25, xmax=14.7)
fig.set_figwidth(4)
fig.set_figheight(3)

ax.legend(ncol=5, loc='upper center')
plt.savefig("aot-startup-throughput.pdf", bbox_inches='tight')
plt.savefig("aot-startup-throughput.png", bbox_inches='tight')
plt.show()
